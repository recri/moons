...
export const navigate = (path, defaultPage) => (dispatch) => {
    // Extract the page name from path, 
    // and default to our main page
    var page = path === '/' ? defaultPage : path.slice(1);
...
const loadPage = (page) => async (dispatch) => {
	...
	// await import('../components/moons-calendar.js');
	break;
    case 'settings': 
	await import('../components/moons-settings.js');
	break;
    case 'about': await import('../components/moons-about.js'); break;
    default: await import('../components/app-404.js'); break;
    }
